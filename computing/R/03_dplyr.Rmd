...
If you look at [`dplyr` docs](https://cran.r-project.org/web/packages/dplyr/dplyr.pdf), there is a rich collection of data manipulation verbs provided. However, most common tasks can be accomplished with just 6 verbs that we will cover in this session:
...
We will also see how to construct data manipulation "sentences" by using these verbs together with `pipes`.

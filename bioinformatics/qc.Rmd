...
**Goal of this script:** QC

Example of QC filtering statement in methods of Christian et al. 2021 Cell Reports (https://doi.org/10.1016/j.celrep.2021.109118): The gene count matrices from cellranger were subjected to quality control, pre-processing and clustering using the R Seurat 2.3.4 package (Butler et al., 2018). Low-quality cells that had less than 200 expressed genes and more than 5% mitochondrial genes were filtered out. 

...
## Make sure the Seurat objects have been QC'd
...
### Identify Tem cluster biomarkers
...
Investigate specific genes by overlaying gene expression on top of the tSNE plot as in the Fig2 B-D plots.
```{r}
...
### Name clusters based on biomarkers and study aims

I **think** the authors decided to assign the following names to these clusters:
...
"Elevated levels of Cxcr6 in TEff/EM p4 are associated with enhanced Pdcd1 expression, in opposition to Il7r and Il18r1 expression, which are expressed in TEff/EM p2." (Christian 2021 Cell Reports)
...
"T cell activation markers Gzmb, Klrc1/2, and Klrd1 are upregulated in TEFF/TEM p4" (Christian 2021 Cell Reports)
...
These results will be used to reproduce... 
...
We can also extent these DE analysis to a path analysis, as the authors did (see Fig 5F).

...
-   cellranger will write various log files to the working directory. Unless using a hack, it does not seem to be possible to specify the location of this directory. Accordingly, we have explicitely changed the working directory (using cd)

- The --output-dir flag can be used to specify the directory of the fastq output directory

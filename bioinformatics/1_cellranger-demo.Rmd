...
See (https://support.10xgenomics.com/single-cell-gene-expression/software/pipelines/latest/advanced/references) for creating a 
custom bundle.
...
Run cellranger's count command to align and map the reads. For the class demo,
we will use a downsampled version of the pbmc8k data (for the full version change
FASTQ0 to FATSQ).
